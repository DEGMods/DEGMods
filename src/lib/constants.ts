...
// Defined in analyticsConfig.ts — a leaf module, because the bootstrap baked
// into index.html at build time reads the same values (see vite.config.ts).
// Change them there; this re-export is what the rest of the app imports.
export {
